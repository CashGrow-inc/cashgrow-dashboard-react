...
type ActivePage = 'dashboard' | 'knowledge' | 'faq';
type DashboardProps = {
...
export function Dashboard({ onNavigateToLanding }: DashboardProps = {}) {
  ...
  const activatePage = useCallback((page: ActivePage) => {
    setActivePage(page);
    setMenuOpen(false);
  }, [setMenuOpen]);
  const navigateToDashboardSection = useCallback(
    ...
    return (
      <div className={classes}>
        ...
        <span id={tooltipId} className="tile-title__bubble" role="tooltip">
          ...
          <a className="tile-title__bubble-link" href="#knowledge-center" onClick={openKnowledgeCenter}>Go to Knowledge center</a>
        </span>
      </div>
    );
  };
    ...
    <div className="app-shell">
      ...
      <nav id="appMenu" className={`app-menu ${isMenuOpen ? 'app-menu--open' : ''}`} aria-hidden={!isMenuOpen}>
        ...
        <ul className="app-menu__list">
          <li><a href="#summary" onClick={(event) => navigateToDashboardSection(event, 'summary')}>Summary</a></li>
          <li><a href="#categories" onClick={(event) => navigateToDashboardSection(event, 'categories')}>Spending Categories</a></li>
          <li><a href="#knowledge-center" onClick={openKnowledgeCenter}>Knowledge center</a></li>
          <li><a href="#faq" onClick={(event) => { event.preventDefault(); activatePage('faq'); }}>FAQ</a></li>
          {onNavigateToLanding && (
            <li><a href="#landing" onClick={(event) => { event.preventDefault(); handleNavigateToLanding(); }}>Back to landing</a></li>
          )}
        </ul>
      </nav>
      {isMenuOpen && (
      ...
      <main>
        {activePage === 'dashboard' ? (
          ...
          <ComingSoonPage
            ...
            description="Curated guidance and playbooks are almost ready. Check back soon for personalized insights."
            onBack={goToDashboard}
          />
        ) : (
          <ComingSoonPage
            title="FAQ"
            description="We're gathering the most common questions and answers to help you get more from CashGrow."
            onBack={goToDashboard}
          />
        )}
      </main>
